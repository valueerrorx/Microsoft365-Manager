...
// Button-Text: leer = placeholder, sonst Anzahl/Labels mit "NICHT"-Präfix bei invert.
...
// Leere Auswahl = "alle sichtbar"; UI stellt das als alle-angehakt dar.
const allMode = computed(() => !props.modelValue.length)
...
// Fixes Menü würde beim Scrollen wegdriften → einfach schließen.
