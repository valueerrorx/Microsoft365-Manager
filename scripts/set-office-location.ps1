...
# Sets officeLocation for multiple users via Microsoft Graph $batch (max 20 PATCHes per request)
param(
...
Write-Host "Setze Buero '$OfficeLocation' fuer $($upnList.Count) Benutzer (Graph Batch)..."
